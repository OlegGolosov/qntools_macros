...
void plotFlow(const char *inputFileName="pbpb13_goodEvent_16_011.corr.root", const char *outputFileName="plots2d.root", int pBeam=13)
{
  cout << "START!\n";
...
//  merge("v1_pionpos_(psd1|psd2|psd3)_4S_(X|Y)");
  ...
  rebin("v1_(pionneg|pionpos|proton)_(.*)_4S_(X|Y|X_Y)_unfold_centrality_(..-..)", {"trPt",{0.4,2.2}}, "star");
  rebin("v1_(proton)_(.*)_4S_(X|Y|X_Y)_rebin_centrality_wide_unfold_centrality_(..-..)", axY_proton,  "proton");
  rebin("v1_(proton)_(.*)_4S_(X|Y|X_Y)_rebin_centrality_wide_unfold_centrality_(..-..)", axPt_proton, "proton");
  rebin("v1_(pionneg|pionpos)_(.*)_4S_(X|Y|X_Y)_rebin_centrality_wide_unfold_centrality_(..-..)", axY_pion, "pion");
  rebin("v1_(pionneg|pionpos)_(.*)_4S_(X|Y|X_Y)_rebin_centrality_wide_unfold_centrality_(..-..)", axPt_pion, "pion");
  unfold("v1_(pionneg|pionpos|proton)_(.*)_4S_(X|Y|X_Y)_rebin_centrality_wide_unfold_centrality_(..-..)_rebin_trPt_(pion|proton)", "trPt", "%1.1f");
  unfold("v1_(pionneg|pionpos|proton)_(.*)_4S_(X|Y|X_Y)_rebin_centrality_wide_unfold_centrality_(..-..)_rebin_trY_(pion|proton)", "trY", "%1.1f");
  ...
  fit("v1_(pionneg|pionpos|proton)_psd1_psd2_psd3_4S_X_unfold_centrality_.*_rebin_trPt_star_proj_trY", "fpol3");
  projectFitParameters("v1_pionneg_psd1_psd2_psd3_4S_X_unfold_(centrality)_(.*)-(.*)_rebin_trPt_star_proj_trY_(fit_fpol3)");
  projectFitParameters("v1_pionpos_psd1_psd2_psd3_4S_X_unfold_(centrality)_(.*)-(.*)_rebin_trPt_star_proj_trY_(fit_fpol3)");
  projectFitParameters("v1_proton_psd1_psd2_psd3_4S_X_unfold_(centrality)_(.*)-(.*)_rebin_trPt_star_proj_trY_(fit_fpol3)");
//  makeMG({"v1_proton_psd1_psd2_psd3_4S_X_unfold_centrality_(..-..)_rebin_trPt_star_proj_trY_fit_fpol3"})->Draw("apl");
//  makeMG({"v1_(pionneg|pionpos|proton)_psd1_psd2_psd3_4S_X_unfold_centrality_rebin_trPt_star_proj_trY_fit_fpol3_par1"})->Draw("apl");
...
//  writeMG({"v1_proton_(psd.)_4S_X_Y_rebin_centrality_wide_unfold_centrality_10_25_rebin_trY_0_1.2_proj_trPt"});
  for (int i=1; i<centBinsWide.size(); i++)
  {
    ...
    writeMG({
             Form("v1_proton_psd1_4S_X_rebin_centrality_wide_unfold_centrality_%s_rebin_trPt_proton_unfold_trPt_(.*)_proj_trY", cent),
             Form("v1_proton_psd3_4S_X_rebin_centrality_wide_unfold_centrality_%s_rebin_trPt_proton_unfold_trPt_(.*)_proj_trY", cent),
             Form("v1_proton_psd1_psd2_psd3_4S_X_rebin_centrality_wide_unfold_centrality_%s_rebin_trPt_proton_unfold_trPt_(.*)_proj_trY", cent),
             });
    writeMG({
             Form("v1_proton_psd1_4S_X_rebin_centrality_wide_unfold_centrality_%s_rebin_trY_proton_unfold_trY_(.*)_proj_trPt", cent),
             Form("v1_proton_psd3_4S_X_rebin_centrality_wide_unfold_centrality_%s_rebin_trY_proton_unfold_trY_(.*)_proj_trPt", cent),
             Form("v1_proton_psd1_psd2_psd3_4S_X_rebin_centrality_wide_unfold_centrality_%s_rebin_trY_proton_unfold_trY_(.*)_proj_trPt", cent),
             });
  }
  writeMG({"v1_proton_psd1_psd2_psd3_4S_X_unfold_centrality_(..-..)_rebin_trPt_star_proj_trY_fit_fpol3"});
...
//  writeMG({"v1_pionneg_(psd.)_4S_X_Y_rebin_centrality_wide_unfold_centrality_10_25_rebin_trY_0_1.2_proj_trPt"});
  for (int i=1; i<centBinsWide.size(); i++)
  {
    const char *cent=Form("%02.0f-%02.0f", centBinsWide.at(i-1), centBinsWide.at(i));
    writeMG({
             Form("v1_pionneg_psd1_4S_X_rebin_centrality_wide_unfold_centrality_%s_rebin_trPt_pion_unfold_trPt_(.*)_proj_trY", cent),
             Form("v1_pionneg_psd3_4S_X_rebin_centrality_wide_unfold_centrality_%s_rebin_trPt_pion_unfold_trPt_(.*)_proj_trY", cent),
             Form("v1_pionneg_psd1_psd2_psd3_4S_X_rebin_centrality_wide_unfold_centrality_%s_rebin_trPt_pion_unfold_trPt_(.*)_proj_trY", cent),
             });
    writeMG({
             Form("v1_pionneg_psd1_4S_X_rebin_centrality_wide_unfold_centrality_%s_rebin_trY_pion_unfold_trY_(.*)_proj_trPt", cent),
             Form("v1_pionneg_psd3_4S_X_rebin_centrality_wide_unfold_centrality_%s_rebin_trY_pion_unfold_trY_(.*)_proj_trPt", cent),
             Form("v1_pionneg_psd1_psd2_psd3_4S_X_rebin_centrality_wide_unfold_centrality_%s_rebin_trY_pion_unfold_trY_(.*)_proj_trPt", cent),
             });
  }
  writeMG({"v1_pionneg_psd1_psd2_psd3_4S_X_unfold_centrality_(..-..)_rebin_trPt_star_proj_trY_fit_fpol3"});
...
//  writeMG({"v1_pionpos_(psd.)_4S_X_Y_rebin_centrality_wide_unfold_centrality_10_25_rebin_trY_0_1.2_proj_trPt"});
  for (int i=1; i<centBinsWide.size(); i++)
  {
    const char *cent=Form("%02.0f-%02.0f", centBinsWide.at(i-1), centBinsWide.at(i));
    writeMG({
             Form("v1_pionpos_psd1_4S_X_rebin_centrality_wide_unfold_centrality_%s_rebin_trPt_pion_unfold_trPt_(.*)_proj_trY", cent),
             Form("v1_pionpos_psd3_4S_X_rebin_centrality_wide_unfold_centrality_%s_rebin_trPt_pion_unfold_trPt_(.*)_proj_trY", cent),
             Form("v1_pionpos_psd1_psd2_psd3_4S_X_rebin_centrality_wide_unfold_centrality_%s_rebin_trPt_pion_unfold_trPt_(.*)_proj_trY", cent),
             });
    writeMG({
             Form("v1_pionpos_psd1_4S_X_rebin_centrality_wide_unfold_centrality_%s_rebin_trY_pion_unfold_trY_(.*)_proj_trPt", cent),
             Form("v1_pionpos_psd3_4S_X_rebin_centrality_wide_unfold_centrality_%s_rebin_trY_pion_unfold_trY_(.*)_proj_trPt", cent),
             Form("v1_pionpos_psd1_psd2_psd3_4S_X_rebin_centrality_wide_unfold_centrality_%s_rebin_trY_pion_unfold_trY_(.*)_proj_trPt", cent),
             });
  }
  writeMG({"v1_pionpos_psd1_psd2_psd3_4S_X_unfold_centrality_(..-..)_rebin_trPt_star_proj_trY_fit_fpol3"});

  writeMG({"v1_(pionneg|pionpos|proton)_psd1_psd2_psd3_4S_X_unfold_centrality_rebin_trPt_star_proj_trY_fit_fpol3_par1"});
